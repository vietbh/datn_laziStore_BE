        ...
        <div class="container">
            <nav class="bg-white" aria-label="breadcrumb">
                <ol class="breadcrumb bg-white">
                  <li class="breadcrumb-item"><a href="{{ route('fe.news.index') }}" class=""><u>Trang chủ</u></a></li>
                  {{-- <li class="breadcrumb-item"><a href="{{ route('fe.category.show', ['slug'=>$category->slug]) }}" class="text-primary">{{$category->name}}</a></li> --}}
                  <li class="breadcrumb-item active" aria-current="page">Tìm kiếm <u>{{ request()->query('search') }}</u></li>
                </ol>
            </nav>
            <div class="row">
                <div class="col-lg-8">
                    <div class="row d-flex justify-content-between">
                        <div class="col-lg-12 col-md-12">
                            <div class="section-tittle mb-30">
                                <h4 class="font-weight-bold">Tìm kiếm <u>{{ request()->query('search') }}</u></h4>
                            </div>
                    ...
                    <div class="row">
                        <div class="col-12">
                            ...
                            <div class="tab-content" id="nav-tabContent">
                                <!-- card one -->
                                {{-- <div class="tab-pane fade show active" id="{{ route('tin.single',['idTL' => $tins->id_TL]) }}" role="tabpanel" aria-labelledby="nav-home-tab">           
                                </div> --}}
                                            ...
                                            <div class="col-lg-6 col-md-6">
                                                <div class="single-what-news mb-100">
                                                    ...
                                                    <div class="what-cap">
                                                        ...
                                                        {{-- <span 
                                                        class="color1">{{ $news->views }} <i class="fa fa-eye" aria-hidden="true"></i> </span> --}}
                                        ...
                                        @empty
                                            <div class="single-what-news mb-100 container-fluid">
                                                <div class="alert alert-warning" role="alert">
                                                    <h3 class="text-center">Không tìm thấy !</h3>
                                                </div>
                                            </div>
                                        @endforelse
                                    </div>
