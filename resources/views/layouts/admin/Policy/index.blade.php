       ...
       <div class="bg-light text-center rounded p-4">
           ...
           <div style="min-height: 70vh;">
               <table class="table text-start align-middle table-bordered table-hover mb-0" id="table-items">
                   ...
                   <tbody>
                    @forelse ($policies as $poli)
                        <tr>
                            <td>
                                <div class="d-flex">
                                    <a class="btn btn-sm btn-primary me-2" href="{{ route('policy.edit', ['id' => $poli->id]) }}"><i class="fas fa-edit"></i></a>
                    ...
                    @empty
                        <tr><th colspan="10" class="text-center m-3">Không tồn tại</th></tr>
                    @endforelse                      
                   </tbody>
               </table>
           </div>
