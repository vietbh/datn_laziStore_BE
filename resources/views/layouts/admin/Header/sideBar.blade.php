    ...
    <nav class="navbar bg-light navbar-light">
        ...
        <div class="d-flex align-items-center ms-4 mb-4">
            <div class="position-relative">
                ...
                @if (Auth::user()->user_status) <div class="bg-success rounded-circle border-2 border-white position-absolute end-0 bottom-0 p-1"></div>
                @else <div class="bg-danger rounded-circle border-2 border-white position-absolute end-0 bottom-0 p-1"></div>
                @endif
            </div>
            <div class="ms-3">
        ...
        <div class="navbar-nav w-100">            
            ...
            <a href="{{ route('product.cat.index') }}" class="nav-item nav-link text-nowrap {{request()->routeIs('product.cat.index','product.cat.edit') == 1 ? 'active':''}}"><i class="far fa-list-alt"></i>Danh mục sản phẩm</a>
            <a href="{{ route('product.index') }}" class="nav-item nav-link {{request()->routeIs('product.index','product.edit') == 1 ? 'active':''}}"><i class="fa fa-laptop me-2"></i>Sản phẩm</a>
            ...
            <a href="{{ route('news.cat.index') }}" class="nav-item nav-link text-nowrap {{request()->routeIs('news.cat.index','news.cat.edit') == 1 ? 'active':''}}"><i class="far fa-list-alt"></i>Danh mục tin tức</a>
            <a href="{{ route('news.tag.index') }}" class="nav-item nav-link {{request()->routeIs('news.tag.index') == 1 ? 'active':''}}"><i class="fas fa-tags"></i>Tag</a>
            <a href="{{ route('news.index') }}" class="nav-item nav-link {{request()->routeIs('news.index','news.edit') == 1 ? 'active':''}}"><i class="fa fa-newspaper me-2"></i>Tin tức</a>
            ...
            <a href="{{ route('policy.index') }}" class="nav-item nav-link {{request()->routeIs('policy.index','policy.edit') == 1 ? 'active':''}}"><i class="fas fa-certificate me-2"></i></i>Chính sách</a>
