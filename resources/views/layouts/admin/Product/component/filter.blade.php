<div class="mb-3 row">
    <!-- Split dropstart button -->
                   ...
                   <ul class="dropdown-menu" style="min-width: 100vh">
                       <li>
                           <div class="container p-3">
                               ...
                               <form class="row gy-1 mt-2" action="{{ route('product.filter') }}" method="get">
                                   @csrf
       ...
       <div class="col-lg-4">
           <form class="d-flex justify-content-end" action="{{ route('product.filter') }}" method="get">
               @csrf
               <div class="col-md-12">
                    <div class="input-group">
                        <input type="text" class="form-control border-0 " name="search" value="{{request()->get('search')}}" placeholder="Tìm kiếm sản phẩm">
