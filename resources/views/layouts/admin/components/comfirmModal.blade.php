...
{{-- <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#comfirmModal">
  ...
  id="comfirmModal{{$modal['param']}}"
  tabindex="-1"
  aria-labelledby="comfirmModal{{$modal['param']}}"
  aria-hidden="true">
        ...
        <div class="modal-body">
          ...
          <div class="container">
            ...
            <div class="row mb-3 float-start">
              <h5 class="modal-title">Bạn có chắc là muốn xóa <span>{{$modal['name']}}</span> ?</h5>
              ...
              <div class="row px-3 pt-3">
                ...
                <div class="col-sm-12 col-lg-6">
                  <form action="{{ route( $modal['route']['delete'], 
                  ['id' => $modal['param']] )}}"
                  method="POST">
                    @csrf
                    @method('delete')
